...
class MyApp extends StatelessWidget {
  static final String title = 'Image Widget Example';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: title,
      theme: ThemeData(primarySwatch: Colors.red,bottomAppBarTheme: BottomAppBarTheme.of(context) ),
...
class _HomePageState extends State<HomePage> {
  ...
  // Load image from System file on target device
